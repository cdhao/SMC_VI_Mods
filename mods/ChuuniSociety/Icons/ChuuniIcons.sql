...
INSERT OR REPLACE INTO IconDefinitions (Name, Atlas, "Index")
SELECT 'ICON_RESOURCE_CHUUNI_VALUE', Atlas, "Index"
FROM IconDefinitions
WHERE Name = 'ICON_RESOURCE_NITER';

INSERT OR REPLACE INTO IconDefinitions (Name, Atlas, "Index")
SELECT 'ICON_RESOURCE_CHUUNI_VALUE_FOW', Atlas, "Index"
FROM IconDefinitions
WHERE Name = 'ICON_RESOURCE_NITER_FOW';

INSERT OR REPLACE INTO IconDefinitions (Name, Atlas, "Index")
SELECT 'RESOURCE_CHUUNI_VALUE', Atlas, "Index"
FROM IconDefinitions
WHERE Name = 'RESOURCE_NITER';
...
VALUES
    ...
    ('ICON_ATLAS_CHUUNI_VALUE_FONT', 6, 22, 1, 1, 'Chuuni_Icon_ChuuniValue_22');
...
INSERT OR REPLACE INTO IconDefinitions (Name, Atlas, "Index") VALUES
    ...
    ('ICON_RESOURCE_CHUUNI_VALUE', 'ICON_ATLAS_CHUUNI_VALUE', 0),
    ('ICON_RESOURCE_CHUUNI_VALUE_FOW', 'ICON_ATLAS_CHUUNI_VALUE', 0),
    ('RESOURCE_CHUUNI_VALUE', 'ICON_ATLAS_CHUUNI_VALUE_FONT', 0),
