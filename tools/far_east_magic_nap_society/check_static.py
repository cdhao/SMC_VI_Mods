...
def check_runtime_layout(root: Path) -> None:
    ...
    for relative in (
        ...
        "Data/RikkaCombat.sql",
        "Data/Chimera.sql",
        "Data/UpgradeDiscounts.sql",
        "Data/DistrictBuilding.sql",
        "Data/InvisibleBoundary.sql",
        "Data/FaithPurchase.sql",
        ...
        (
            ...
            TextContract(
                ...
                required=(
                    ...
                    "CHUUNI_CHIMERA_FAITH_TIER",
                    "EnsureChimeraYieldTiers",
                    "CHUUNI_CHIMERA_CULTURE_TIER",
                    "CHUUNI_CHIMERA_SCIENCE_TIER",
                    "RefreshChimeraUnitAbilities",
                    "GameEvents.ChuuniTeleport.Add",
            ...
            TextContract(
                ...
                forbidden=("GovernorNormal_Builder", "GovernorSelected_Builder"),
            ),
            TextContract(
                mod_root / "Data/StageCombat.sql",
                required=(
                    "RESOURCE_CHUUNI_STAGE_MARKER_1",
                    "RESOURCE_CHUUNI_STAGE_MARKER_2",
                    "RESOURCE_CHUUNI_STAGE_MARKER_3",
                    "RESOURCE_CHUUNI_STAGE_MARKER_4",
                    "RESOURCECLASS_BONUS",
                    "CivilopediaPageExcludes",
                    "CHUUNI_FANTASY_COMBAT_STAGE_1_FULL",
                    "CHUUNI_FANTASY_COMBAT_STAGE_2_FULL",
                    "CHUUNI_FANTASY_COMBAT_STAGE_3_FULL",
                    "CHUUNI_FANTASY_COMBAT_STAGE_4_FULL",
            ...
            TextContract(
                mod_root / "Data/UpgradeDiscounts.sql",
                required=(
                ...
                forbidden=("ChangeGoldBalance", "Lua refund"),
            ),
            TextContract(
                mod_root / "Data/InvisibleBoundary.sql",
                required=(
            ...
            TextContract(
                mod_root / "Data/FaithPurchase.sql",
                required=(
